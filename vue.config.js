...
module.exports = {
  ...
  devServer: {
    ...
    open: true,
    proxy: {
      // [`${process.env.VUE_APP_BASE_API}/cmict-project-retrieval`]: {
      //   target: `http://10.136.144.15:8898`, // lyy
      //   changeOrigin: true,
      // },

      [`${process.env.VUE_APP_BASE_API}/minio`]: {
        target: `https://192.168.113.71:9000`,
