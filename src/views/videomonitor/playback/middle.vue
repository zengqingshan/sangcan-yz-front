<template>
  <div style="height: 100%;">
      ...
      <div class="video-show col-md-9 col-lg-10" style="flex:1">
        <el-row>
          <el-col :span="12" style="margin-top: 15px;">
            <i
              :class="{ 'el-icon-star-off': !starFlag, 'el-icon-star-on': starFlag }"
              ...
              <el-button-group class="player-btn-group">
                ...
                <el-dropdown trigger="click">
                  <el-button type="primary">
                    {{ getPlayerLengthDisplayName() }}<i class="el-icon-arrow-down el-icon--right" />
                  </el-button>
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item v-for="list in playerBtnGroup" :key="list.num" :command="list.command || 's'">
                      <el-button
                        size="medium"
        ...
        <el-row v-if="showcovers" class="elrows">
          <el-col style="height:100%;">
            <div style="height:85%;">
              <VideoPlayers id="videoPlayers" ref="hlsVideoPlayer" style="width: 100%; height: 100%" @starpoill="pollingstart" @activeclose="activeclose" />

            </div>

          </el-col>
        </el-row>
        <div v-else class="video-show col-md-9 col-lg-10" style="flex:1;width: 100%;">
    ...
    <!-- 定位按钮 -->
    <span v-show="(layoutnumtoo < allvediolist.length) && pagenext" class="pos-right" @click="nextvedio">
    ...
    layoutNum(newval) {
      if (this.pollgropcontrol) {
        ...
        for (this.i; this.i < newval; this.i++) {
          this.$bus.$emit('playhistoryvedio', this.allvediolist[this.i].serviceId, this.allvediolist[this.i].name)
        }
      }
    }
  },
