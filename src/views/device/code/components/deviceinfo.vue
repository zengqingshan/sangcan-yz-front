<template>
  <div class="videoStorageStrategy_main">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="设备SIP-ID" prop="serviceId">
                <el-input
                  v-model="sizeForm.serviceId"
                  :disabled="true"
                  placeholder="请输入设备SIP-ID"
                />
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="所属平台" prop="platformName">
                <el-input
                  v-model="sizeForm.platformName"
                  :disabled="true"
                  placeholder="请输入存储策略名称"
                />
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="经纬度" prop="Latitudeandlongitude">
                <el-input
                  v-model="sizeForm.Latitudeandlongitude"
                  placeholder="请输入经纬度"
                  @change="lalongChange"
                >
                  <el-button
    ...
    <el-row>
      <el-col :offset="22" style="margin-left: 80%;">
        <el-button
          size="mini"
          type="primary"
          @click="onSubmit"
