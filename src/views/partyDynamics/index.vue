  ...
  <div class="app-container" style="display: block;">
    <el-card class="box-card">
      <el-form
        ...
        label-width="68px"
      >
        <el-form-item label="所属村（社区）" prop="activityName" label-width="100px">
          <el-select
      ...
      <el-table-column label="党支部名称" align="center" prop="activityType" />
      <el-table-column label="排序" align="center" prop="activityType" />
      ...
      >
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-col :span="8">
            <el-form-item label="所属村（社区）" prop="activityName">
              <el-select
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="资讯类型" prop="activityType">
                <el-select
                  v-model="form.activityType"
                  placeholder="资讯类型"
                  clearable
          ...
          <el-form-item label="图片" prop="cyclePicture">
