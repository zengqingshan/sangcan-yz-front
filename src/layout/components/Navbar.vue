      ...
      <el-dropdown trigger="click" style="margin-left:30px;">
        ...
        <el-dropdown-menu slot="dropdown" style="margin-left: 2%;">
          ...
          <template  v-for="(item, index) in $store.getters.tenantList">
            <el-dropdown-item style="width:300px;"  @click.native="switchTenant(item)" >
              
              <div style="position: relative;">
                <span  v-if="item.isLogined " > 
                <svg style="color: rgb(36, 26, 229); position: absolute; top: 20%; left: -2%;"  viewBox="64 64 896 896" focusable="false" data-icon="check" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                <path d="M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 00-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z" />
              </svg>
                             
              </span>
              <span style="margin-left: 20px;">{{ item.tenant.name }}</span>
              <span style="float: right;color: #c8c8c8;">{{ getRoleName(item) }}</span>
              </div>
...
::v-deep [data-v-35f3a2c1] .el-menu--horizontal > .el-submenu .el-submenu__title{
  line-height: 43px;
  // display: flex;
